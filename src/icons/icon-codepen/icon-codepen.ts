...
@customElement(getComponentName("icon-codepen"))
export class IconCodepen extends LitElement {
  static styles = unsafeCSS(styleData);

  render() {
    return html`
     <svg class="sil-icon" version="1.1" id="IconCodepen" x="0px" y="0px"
