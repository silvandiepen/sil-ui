...
@customElement(getComponentName("icon-profile"))
export class IconProfile extends LitElement {
  static styles = unsafeCSS(styleData);

  render() {
    return html`
     <svg class="sil-icon" version="1.1" id="IconProfile" x="0px" y="0px"
