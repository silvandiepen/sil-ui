...
@customElement(getComponentName("icon-import"))
export class IconImport extends LitElement {
  static styles = unsafeCSS(styleData);

  render() {
    return html`
     <svg class="sil-icon" version="1.1" id="IconImport" x="0px" y="0px"
